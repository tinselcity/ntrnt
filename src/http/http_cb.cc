...
//! Macros
//! ----------------------------------------------------------------------------
#define CALC_OFFSET(_hmsg, _at) ((_at - _hmsg->m_cur_buf) + _hmsg->m_cur_off)
...
//! \param:   TODO
//! ----------------------------------------------------------------------------
int hp_on_header_field(http_parser* a_parser, const char* a_at,
                       size_t a_length) {
  http_msg* l_hmsg = static_cast<http_msg*>(a_parser->data);
  CHECK_FOR_NULL_OK(l_hmsg);
  cr_struct l_cr;
...
//! \param:   TODO
//! ----------------------------------------------------------------------------
int hp_on_header_value(http_parser* a_parser, const char* a_at,
                       size_t a_length) {
  http_msg* l_hmsg = static_cast<http_msg*>(a_parser->data);
  CHECK_FOR_NULL_OK(l_hmsg);
  cr_struct l_cr;
