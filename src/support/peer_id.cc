...
//! macros
//! ----------------------------------------------------------------------------
#define _FORMATTER(_type)                                               \
  std::string _formatter_##_type(const char* a_name, size_t a_name_len, \
                                 const peer_id_t& a_id)
namespace ns_ntrnt {
//! ----------------------------------------------------------------------------
//! types
//! ----------------------------------------------------------------------------
typedef std::string (*_formatter_t)(const char* a_name, size_t a_name_len,
                                    const peer_id_t& a_id);
struct _client {
  const char* m_prefix;
