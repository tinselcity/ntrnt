...
const char* get_date_str(void) {
  ...
  strftime(g_last_date_str, sizeof g_last_date_str, "%a, %d %b %Y %H:%M:%S %Z",
           &l_tm);
  return g_last_date_str;
}
//! ----------------------------------------------------------------------------
...
uint64_t get_time_ms(void) {
  ...
  struct timespec l_timespec;
  _rt_gettime(l_timespec);
  g_last_ms = (((uint64_t)l_timespec.tv_sec) * 1000) +
              (((uint64_t)l_timespec.tv_nsec) / 1000000);
  return g_last_ms;
}
//! ----------------------------------------------------------------------------
//! \details: TODO
...
uint64_t get_time_us(void) {
  ...
  struct timespec l_timespec;
  _rt_gettime(l_timespec);
  g_last_us = (((uint64_t)l_timespec.tv_sec) * 1000000) +
              (((uint64_t)l_timespec.tv_nsec) / 1000);
  return g_last_us;
}
//! ----------------------------------------------------------------------------
//! \details: TODO
