...
typedef std::priority_queue<evr_event_t*, std::vector<evr_event_t*>,
                            evr_compare_events>
    evr_event_pq_t;
//! ----------------------------------------------------------------------------
...
class evr {
 public:
  evr(){};
  virtual ~evr(){};
  virtual int wait(evr_events_t* a_ev, int a_max_events,
                   int a_timeout_msec) = 0;
...
class evr_loop {
 public:
  ...
  // Timer events...
  // -------------------------------------------
  int32_t add_event(uint32_t a_time_ms, evr_event_cb_t a_cb, void* a_data,
