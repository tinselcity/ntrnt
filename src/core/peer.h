...
// ---------------------------------------------------------
const uint8_t g_btp_str[20] = {0x13, 0x42, 0x69, 0x74, 0x54, 0x6f, 0x72,
                               0x72, 0x65, 0x6e, 0x74, 0x20, 0x70, 0x72,
...
class peer {
 public:
  ...
  // public methods
  // -------------------------------------------------
  peer(peer_from_t a_from, session& a_session, peer_mgr& a_peer_mgr,
  ...
  uint64_t utp_cb(utp_socket* a_utp_conn, int a_type, int a_state,
  ...
  bool get_ltep_msg_support_ut_metadata(void) {
    return m_ltep_msg_support_ut_metadata;
  }
