...
const str_scheme_map_t g_str_scheme_map(
                ...
                g_str_scheme_map_pairs + (sizeof(g_str_scheme_map_pairs)/sizeof(g_str_scheme_map_pairs[0])));
//! ----------------------------------------------------------------------------
...
const scheme_str_map_t g_scheme_str_map(
                ...
                g_scheme_str_map_pairs + (sizeof(g_scheme_str_map_pairs)/sizeof(g_scheme_str_map_pairs[0])));
//! ----------------------------------------------------------------------------
//!  \details TODO
//!  \return  TODO
//!  \param   TODO
