...
//! types
//! ----------------------------------------------------------------------------
typedef int32_t (*ssl_accept_cb_t)(void*, const struct sockaddr*, SSL**,
                                   SSL_CTX**);
//! ----------------------------------------------------------------------------
//! \details: TODO
//! ----------------------------------------------------------------------------
class nconn {
 public:
  ...
  void setup_evr_fd(evr_event_cb_t a_read_cb, evr_event_cb_t a_write_cb,
  ...
  virtual int32_t set_opt(uint32_t a_opt, const void* a_buf,
                          uint32_t a_len) = 0;
