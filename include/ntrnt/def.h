...
#define NTRNT_SESSION_UTP_RECV_BUF_SIZE { 256 * 1024 }
#define NTRNT_SESSION_MAX_CONNS 20
#define NTRNT_SESSION_PEER_MAX_INFLIGHT 512
#define NTRNT_SESSION_PEER_INFLIGHT_LOW_WATER 64
#define NTRNT_SESSION_PEER_INFLIGHT_EXPIRES_MS 10000 // 10 seconds
#define NTRNT_SESSION_PEER_MAX_IDLE_S 60
#define NTRNT_SESSION_NUMWANT 80
#define NTRNT_SESSION_TRACKER_ANNOUNCE_RETRY_S 30 // 10 seconds
#define NTRNT_SESSION_TRACKER_ANNOUNCE_S 1200 // 30 minutes
#define NTRNT_SESSION_TRACKER_SCRAPE_RETRY_S 10 // 10 seconds
